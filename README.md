...
2.กำหนดขาให้ไฟ LED กระพริบ 

![image](https://github.com/user-attachments/assets/6829dae0-9e25-4fa7-872a-bcd26e20f899)

3.ไปที่ ESP-IDF: SDK configuration editor (menuconfig) เพื่อตั้งค่าการใช้งานสำหรับโปรเจกต์ blink ตรวจสอบการตั้งค่าในส่วนที่เรียกว่า "Example Configuration" เพื่อกำหนดค่า GPIO 
...
5.BLINK LED สามารถกำหนดเองผ่าน code หรือ ESP-IDF: SDK configuration editor ได้เพื่อให้ไฟ LED สามารถติดดับได้ตามที่กำหนด
